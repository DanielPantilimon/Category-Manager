...
//Let's update this function so it will return the user profile with the departments list.
//Also, let's get the department that this current user belongs to and pass it to the view.
    public function getUserProfile($id){

        $user = User::with('department')->find($id);
        $departments = Departments::all();
        $userDepartment = $user->departments ?? null;
